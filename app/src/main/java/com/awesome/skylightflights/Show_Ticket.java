...
public class Show_Ticket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //flightRef = db.collection("flights").document().collection(passenger1.getDate_day()+"."+passenger1.getDate_month()+"."+passenger1.getDate_year()).document(passenger1.getFlight());
