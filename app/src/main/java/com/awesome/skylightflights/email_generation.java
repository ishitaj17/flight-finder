        ...
        Thread sender = new Thread(new Runnable() {
            ...
            public void run() {
                try
                {
                    ...
                    // e.g. if email id is "skylights.airlines@gmail.com" and password is "password"then enter it as :-
                    GMailSender mailSender = new GMailSender("skylights.airlines@gmail.com", "password");
                   ...
                   mailSender.sendMail("Skylights Flights Welcome You To Sky",body,"skylights.airlines@gmail.com",
